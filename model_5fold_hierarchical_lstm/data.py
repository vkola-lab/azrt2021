...
class AudioDataset(Dataset):
    ...
    def __init__(self, dir_mfcc, csv, mode, comb=(0, 1), seed=3227, get_label=None):
        ...
        self.mode = mode
        self.df = None
        self.get_label = lambda r: int(r['is_demented_at_recording']) if get_label is None else get_label
        ...
        lst = []
        for pat, afn, lbl in lst_p_a_l:
            # fea = np.load(afn, mmap_mode='r')
            lst.append((pat, afn, lbl))
